...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/model/model_our_dataset.csv")
...
for i in range(len(df)):
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/model/evaluation/Comparision_Pipeline_our.csv", index=False)
