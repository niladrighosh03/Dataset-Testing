...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/qween/single/Qween_single_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'Qwen_2.5_7B_instruct Response Single'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/qween/single/Comparision_Qween_single.csv", index=False)
