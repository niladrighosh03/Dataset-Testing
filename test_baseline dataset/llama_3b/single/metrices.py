...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/llama_3b/single/llama3b_single_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'Llama3.2_3B_instruct Response Single'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/llama_3b/single/Comparision_llama_3b_single.csv", index=False)
