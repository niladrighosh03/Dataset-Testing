...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/krutrim-cloud/qween/qween_single_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'Qween Single Response'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/krutrim-cloud/qween/Comparision_qween_api.csv", index=False)
