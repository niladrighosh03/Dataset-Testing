...
# %%
def create_dataset():
    df = pd.read_csv('/home/rohank__iitp/Work/niladri/test_baseline dataset/krutrim-cloud/test_100convo.csv')

    if not df.empty:
        output_filename = '/home/rohank__iitp/Work/niladri/test_baseline dataset/krutrim-cloud/deepseek/deepseek_single_dataset.csv'
        ...
        for conversation_id, group in grouped:
            ...
            for index, row in group.iterrows():
                ...
                current_row_data['deepseek Single Response'] = krutrim_response
