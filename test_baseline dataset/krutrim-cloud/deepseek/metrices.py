...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/krutrim-cloud/deepseek/deepseek_single_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'deepseek Single Response'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/krutrim-cloud/deepseek/Comparision_deepseek_api.csv", index=False)
