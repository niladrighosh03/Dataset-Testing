...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/llama_8b/single/llama8b_single_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'llama_3.1 8b Response Single'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/llama_8b/single/Comparision_llama_8b_single.csv", index=False)
