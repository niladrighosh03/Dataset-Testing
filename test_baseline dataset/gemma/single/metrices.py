...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/gemma/single/gemma_single_dataset.csv")
...
for i in range(len(df)):
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/gemma/single/Comparision_Qween_single.csv", index=False)
