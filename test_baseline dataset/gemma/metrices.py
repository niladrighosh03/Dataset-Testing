...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/gemma/allexp/gemma_allexp_dataset.csv")
...
for i in range(len(df)):
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/gemma/allexp/Comparision_Gemma_allexp.csv", index=False)
