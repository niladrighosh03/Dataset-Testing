...
def create_dataset():
    ...
    if not df.empty:
        output_filename = '/home/rohank__iitp/Work/niladri/test_baseline dataset/phi/router/phi_router_dataset.csv'
        ...
        for conversation_id, group in grouped:
            ...
            for index, row in group.iterrows():
                ...
                current_row_data['phi Router Response'] = qwen_response
