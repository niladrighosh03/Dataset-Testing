...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/phi/allexp/phi_allexp_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'Phi Allexp Response'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/phi/allexp/Comparision_Phi_allexp.csv", index=False)
