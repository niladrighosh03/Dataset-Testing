...
model_name = "/scratch/rohank__iitp/phi3_medium"
...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/phi/single/phi_single_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'Phi3_medium_instruct Response Single'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/test_baseline dataset/phi/single/Comparision_Phi_single.csv", index=False)
