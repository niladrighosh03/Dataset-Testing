...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/llama_3b/router/llama3b_router_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'llama3b Router Response'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/llama_3b/router/Comparision_llama_3b_router.csv", index=False)
