...
def create_dataset():
    ...
    if not df.empty:
        output_filename = '/home/rohank__iitp/Work/niladri/Deal Dataset/llama_3b/router/llama3b_router_dataset.csv'
        ...
        for conversation_id, group in grouped:
            ...
            for index, row in group.iterrows():
                ...
                current_row_data['llama3b Router Response'] = qwen_response
