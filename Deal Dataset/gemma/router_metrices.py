...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/gemma/router/gemma_router_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'gemma Router Response'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/gemma/router/Comparision_Gemma_router.csv", index=False)
