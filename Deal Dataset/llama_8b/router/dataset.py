...
def create_dataset():
    ...
    if not df.empty:
        output_filename = '/home/rohank__iitp/Work/niladri/Deal Dataset/llama_8b/router/llama8b_router_dataset.csv'
        ...
        for conversation_id, group in grouped:
            ...
            for index, row in group.iterrows():
                ...
                current_row_data['llama8b Router Response'] = qwen_response
