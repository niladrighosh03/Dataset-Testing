...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/llama_8b/allexp/llama_8b_allexp_dataset.csv")
...
for i in range(len(df)):
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/llama_8b/allexp/Comparision_llama_8b_allexp.csv", index=False)
