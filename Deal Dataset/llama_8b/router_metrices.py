...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/llama_8b/router/llama8b_router_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'llama8b Router Response'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/llama_8b/router/Comparision_llama_8b_router.csv", index=False)
