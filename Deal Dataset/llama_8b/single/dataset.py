...
def create_dataset():
    ...
    if not df.empty:
        output_filename = '/home/rohank__iitp/Work/niladri/Deal Dataset/llama_8b/single/llama_8b_single_dataset.csv'
        ...
        for conversation_id, group in grouped:
            ...
            for index, row in group.iterrows():
                ...
                current_row_data['llama_8b Single Response'] = qwen_response
