...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/krutrim-cloud/qween/qween_single_dataset.csv")
...
for i in range(len(df)):
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/krutrim-cloud/qween/Comparision_qween_api.csv", index=False)
