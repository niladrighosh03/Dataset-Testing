...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/qween/router/qween_router_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'qween Router Response'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/qween/router/Comparision_Qween_router.csv", index=False)
