...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/qween/allexp/qween_allexp_dataset.csv")
...
for i in range(len(df)):
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/qween/allexp/Comparision_Qween_allexp.csv", index=False)
