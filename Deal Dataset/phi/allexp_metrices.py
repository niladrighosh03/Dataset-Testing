...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/phi/allexp/phi_allexp_dataset.csv")
...
for i in range(len(df)):
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/phi/allexp/Comparision_Phi_allexp.csv", index=False)
