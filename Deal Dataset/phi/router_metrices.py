...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/phi/router/phi_router_dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'phi Router Response'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/Deal Dataset/phi/router/Comparision_Phi_router.csv", index=False)
