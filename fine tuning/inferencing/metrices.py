...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/fine tuning/inferencing/fine_tuned dataset.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'Fine Tuned Qween'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/fine tuning/inferencing/Comparision_Fine Tuned Qween_single.csv", index=False)
