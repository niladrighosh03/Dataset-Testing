...
# Load your dataset
df = pd.read_csv("/home/rohank__iitp/Work/niladri/fine tuning/deal_inferencing/fine tuned deal.csv")
...
for i in range(len(df)):
    ...
    model_reply = str(df.loc[i, 'Fine Tuned Qween_Deal'])
    ...
    df.to_csv("/home/rohank__iitp/Work/niladri/fine tuning/deal_inferencing/Comparision_Fine Tuned Qween_Deal.csv", index=False)
