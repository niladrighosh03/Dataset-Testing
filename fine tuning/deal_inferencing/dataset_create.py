...
def create_dataset():
    ...
    df = pd.read_csv('/home/rohank__iitp/Work/niladri/fine tuning/deal_inferencing/deal dataset.csv')
    # --- Response Generation and Incremental Saving ---

    if not df.empty:
        output_filename = '/home/rohank__iitp/Work/niladri/fine tuning/deal_inferencing/fine tuned deal.csv'
    ...
    Give the reply for this query:\n""" + "Conversation History:\n" + conversation_history + "Current Utterance: " + f"User: {row['utterance']}\nAgent:"
                ...
                current_row_data['Fine Tuned Qween_Deal'] = qwen_response
